...
function search_for_banned_links(t, r) {
    if (t.length) {
        var e = -1 !== (r = r.startsWith("/") ? r.substring(1) : r).indexOf("/") ? r.indexOf("/") : r.indexOf("?"),
...
ready(() => {
    ...
    addEventListener("mouseover", function(r) {
        var n, i;
        r.target instanceof HTMLAnchorElement && (n = new URL(breeze_prefetch.local_url).host, i = r.target.attributes.href ? r.target.attributes.href.value : null) && (-1 === i.indexOf(n) && (i = r.target.href), timer = setTimeout(function() {
            var e, t;
